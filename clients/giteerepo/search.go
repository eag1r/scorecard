...
func (handler *searchHandler) search(request clients.SearchRequest) (clients.SearchResponse, error) {
	...
	resp, _, err := handler.ghClient.SearchApi.GetV5SearchGists(handler.ctx, query, &gitee.GetV5SearchGistsOpts{})
	if err != nil {
...
func searchResponseFrom(resp []gitee.Code) clients.SearchResponse {
